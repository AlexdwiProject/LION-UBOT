    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari LION-USERBOT.`'
            )
            repo.__del__()
            return
        ...
        if heroku_app is None:
            await event.edit(
                f'{txt}\n`Kredensial Heroku tidak valid untuk deploy LION-UBOT dyno.`'
            )
            return repo.__del__()
...
CMD_HELP.update({
    'update':
    ".update"
    "\nUsage: Untuk Melihat Pembaruan Terbaru LION-UBOT."
    "\n\n.update one"
    "\nUsage: Memperbarui LION-UBOT."
    "\n\n.update all"
    "\nUsage: Memperbarui LION-UBOT Dengan Cara Deploy Ulang."
})
