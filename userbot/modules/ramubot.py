...
async def typewriter(typew):
    ...
    await typew.edit("**Aku Kangen Sama Kamu🥺**")
    sleep(2)
    await typew.edit("**Kamu Harus Tau**")
    await typew.edit("**Kamu Harus Tau😌**")
    sleep(2)
    await typew.edit("**Kalo Aku Cinta Kamu🤍**")
    await typew.edit("**Kalo Aku Cinta Kamu❤️**")
    sleep(2)
    await typew.edit("**Jadi Kamu**")
    await typew.edit("**Jadi Kamu,☺️**")
    sleep(2)
    await typew.edit("**Jangan Tinggalin Aku**")
    await typew.edit("**Jangan Tinggalin Aku☹️☺️**")
    sleep(2)
    await typew.edit("**Tetep Disini Yah**")
    await typew.edit("**Tetep Disini Yah🥺✨**")
    sleep(2)
